...
namespace WebClientAPI.Models
{
    ...
    {
        public List<object> languages_hierarchy { get; set; }
        public string ingredients_text_with_allergens { get; set; }
        public List<object> correctors { get; set; }
        public Nutriments nutriments { get; set; }
        public List<object> states_tags { get; set; }
        ...
        public List<object> additives_prev_tags { get; set; }
        public string image_url { get; set; }
        public List<object> informers_tags { get; set; }
        public List<object> additives_original_tags { get; set; }
        public string purchase_places { get; set; }
        public int sortkey { get; set; }
        public List<object> _keywords { get; set; }
        public List<object> editors_tags { get; set; }
        public List<object> ingredients_n_tags { get; set; }
        ...
        public List<object> languages_tags { get; set; }
        public string states { get; set; }
        public string image_front_thumb_url { get; set; }
        public List<object> checkers_tags { get; set; }
        public List<object> photographers_tags { get; set; }
        public List<object> correctors_tags { get; set; }
        public List<object> ingredients_ids_debug { get; set; }
        public string countries { get; set; }
        [JsonProperty(PropertyName = "__invalid_name__fruits-vegetables-nuts_100g_estimate")]
        ...
        public List<object> last_image_dates_tags { get; set; }
        public List<object> checkers { get; set; }
        public List<object> emb_codes_tags { get; set; }
        public List<object> codes_tags { get; set; }
        public string emb_code { get; set; }
        public List<object> countries_hierarchy { get; set; }
        public double serving_quantity { get; set; }
        public string quantity { get; set; }
        public string max_imgid { get; set; }
        public string emb_codes_orig { get; set; }
        public List<object> brands_tags { get; set; }
        public List<object> categories_prev_tags { get; set; }
        ...
        public List<object> states_hierarchy { get; set; }
        public string code { get; set; }
        public List<object> countries_tags { get; set; }
        ...
        public List<object> photographers { get; set; }
        ...
        public List<object> nutrition_grades_tags { get; set; }
        ...
        public List<object> pnns_groups_1_tags { get; set; }
        ...
        public List<object> last_edit_dates_tags { get; set; }
        public string ingredients_text_with_allergens_fr { get; set; }
        public List<object> pnns_groups_2_tags { get; set; }
        ...
        public List<object> entry_dates_tags { get; set; }
        ...
        public List<object> categories_prev_hierarchy { get; set; }
    }
